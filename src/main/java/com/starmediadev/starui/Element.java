...
/**
 * This represents an element in a Gui
 */
public class Element {
    ...
    /**
     * If this element is replaceable with other elements when the Gui is being created
     ...
     * Static elements are only applicable in a PaginatedGui
